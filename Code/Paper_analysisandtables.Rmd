...
Data_mini <- Data %>% select(enfranchisement_final, MHI, LN_POP, Source, Percent.renter, Percent.white, POPULATION, CALENVIRO_SCREEN_SCORE, FAILING, WQ_combined_any, Affordability_combined_any, Accessibility_combined_any, Percent.hispanicorlatino, Percent.black, Percent.asian, Source_bi) 
