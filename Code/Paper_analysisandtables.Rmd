...
Data_mini <- Data %>% select(enfranchisement_final, MHI, MHI_KD, LN_POP, Source, Percent.renter, Percent.white, POPULATION, CALENVIRO_SCREEN_SCORE, FAILING, WQ_combined_any, Affordability_combined_any, TMF_combined_any, Accessibility_combined_any, Percent.hispanicorlatino, Percent.black, Percent.asian) 

Descriptives<- Data_mini %>%
  group_by(enfranchisement_final) %>% 
  summarize(meanLNPOP = mean(na.omit(POPULATION)),
